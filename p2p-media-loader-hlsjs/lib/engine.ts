...
export class Engine extends EventEmitter {
    ...
    private readonly loader: LoaderInterface;       //加载接口
    private readonly segmentManager: SegmentManager;    //segment管理类

    public constructor(settings: Partial<HlsJsEngineSettings> = {}) { //partial作用是将尖括号里的类型转换为可选类型
        super();              //super给父类的构造函数                  //即要么改变尖括号里的类型要么保持不变
